...
import { signedEditDecision, type EditClass, type SignaturePolicy } from './signatures';

// The sweep vocabulary is the shared one: one mirror key, one eligibility
// rule and one signature wording across every folder sweep.
export {
  fileIsEligible,
  ineligibleReason,
  joinDest,
