...
export const OPERATIONS = [
  ...
  'comments', 'preflight', 'outputpreview', 'inkmanager', 'printermarks', 'hairlines', 'flattener', 'links', 'tags', 'readingorder', 'actions', 'takeoff',
...
export const OPERATION_TITLES: Record<Operation, string> = {
  ...
  hairlines: 'Fix Hairlines',
  flattener: 'Flattener Preview',
  links: 'Links',
  tags: 'Tags',
